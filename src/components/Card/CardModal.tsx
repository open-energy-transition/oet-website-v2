  ...
  return (
    <div className="border border-[#77857C] rounded-2xl text-[#0B0C0B] p-4 min-h-[336px] flex flex-col justify-between">
      ...
      <div className="flex justify-between items-center">
        <div className="flex py-1.5 pl-2 pr-5 rounded-[8px] gap-1 shadow bg-[#F4F6F0] font-roboto font-medium text-sm leading-[20px] tracking-[0.1%] text-center">
          <span>
            <svg
              width="21"
              height="22"
        ...
        <div className="flex items-center justify-center w-max gap-2">
          ...
          <div className="p-2">
            <Link href={github || ''}>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_3456_1881)">
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
          ...
          <div className="p-3.5 rounded-2xl bg-[#F4F6F0]">
            <Link href={website || ''}>
              <svg
                width="22"
                height="22"
