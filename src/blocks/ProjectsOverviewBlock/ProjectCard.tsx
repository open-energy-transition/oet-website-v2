...
export const ProjectCard: React.FC<{
  ...
  return (
    <div className="flex flex-col items-start border border-[#D9DCDA] border-t-0 rounded-xl dark:border-dark-blue-gray">
      {imageUrl && (
        <div className="group relative w-full h-[217px] overflow-hidden rounded-xl">
          <Media
            resource={imageUrl}
            className="dark:border-t dark:border-dark-blue-gray object-cover w-full h-full transition-transform duration-500 ease-out group-hover:scale-110"
